...
<title>BoxSite: Contributor Covenant Code of Conduct</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c___users__joseph_workspace__state_bills__box_site_frontend_node_modules_native-duplexpair_code-of-conduct.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
Enforcement</h1>
<p>Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project maintainer at <a href="#" onclick="location.href='mai'+'lto:'+'ann'+'a@'+'add'+'al'+'eax'+'.n'+'et'; return false;">anna@<span style="display: none;">.nosp@m.</span>adda<span style="display: none;">.nosp@m.</span>leax.<span style="display: none;">.nosp@m.</span>net</a>. All complaints will be reviewed and investigated and will result in a response that is deemed necessary and appropriate to the circumstances. The project team is obligated to maintain confidentiality with regard to the reporter of an incident. Further details of specific enforcement policies may be posted separately.</p>
