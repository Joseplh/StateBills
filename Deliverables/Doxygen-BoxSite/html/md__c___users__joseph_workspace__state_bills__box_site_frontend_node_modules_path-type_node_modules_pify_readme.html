...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c___users__joseph_workspace__state_bills__box_site_frontend_node_modules_path-type_node_modules_pify_readme.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
options</h3>
<h4><a class="anchor" id="autotoc_md16107"></a>
multiArgs</h4>
...
<div class="line">    });</div>
<div class="line">}</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md16111"></a>
errorFirst</h4>
<p>Type: <code>boolean</code><br  />
