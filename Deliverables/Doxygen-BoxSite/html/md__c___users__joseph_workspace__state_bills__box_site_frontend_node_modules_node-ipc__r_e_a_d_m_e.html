...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c___users__joseph_workspace__state_bills__box_site_frontend_node_modules_node-ipc__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<hr  />
 <h3><a class="anchor" id="autotoc_md15368"></a>
...
<hr  />
<h3><a class="anchor" id="autotoc_md15370"></a>
IPC Config</h3>
...
<tr class="markdownTableRowOdd">
<td class="markdownTableBodyNone">appspace  </td><td class="markdownTableBodyNone">used for Unix Socket (Unix Domain Socket) namespacing. If not set specifically, the Unix Domain Socket will combine the socketRoot, appspace, and id to form the Unix Socket Path for creation or binding. This is available incase you have many apps running on your system, you may have several sockets with the same id, but if you change the appspace, you will still have app specic unique sockets.   </td></tr>
<tr class="markdownTableRowEven">
...
<hr  />
 <h4><a class="anchor" id="autotoc_md15374"></a>
log</h4>
...
<div class="line">);</div>
 ...
 <h4><a class="anchor" id="autotoc_md15378"></a>
connectToNet</h4>
...
<div class="line">);</div>
 ...
 <h4><a class="anchor" id="autotoc_md15380"></a>
disconnect</h4>
...
<tr class="markdownTableRowOdd">
<td class="markdownTableBodyNone">start  </td><td class="markdownTableBodyNone">start serving need top call <code>serve</code> or <code>serveNet</code> first to set up the server   </td></tr>
<tr class="markdownTableRowEven">
...
<div class="line">    }</div>
<div class="line">);</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15396"></a>
...
<h4><a class="anchor" id="autotoc_md15397"></a>
...
<div class="line"> </div>
<div class="line">ipc.server.start();</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md15398"></a>
...
<div class="line"> </div>
<div class="line">ipc.server.start();</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15399"></a>
...
<div class="line">const myBuffer=new Buffer(6).fill(0);</div>
<div class="line"> </div>
...
<div class="line">    myBuffer</div>
<div class="line">);</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15400"></a>
...
<h4><a class="anchor" id="autotoc_md15401"></a>
Server</h4>
...
<div class="line">}</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md15402"></a>
Client</h4>
<div class="fragment"><div class="line">const fs = require(&#39;fs&#39;);</div>
<div class="line">const ipc = require(&#39;../../node-ipc&#39;);</div>
<div class="line"> </div>
...
Licensed under DBAD license</h3>
