...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c___users__joseph_workspace__state_bills__box_site_frontend_node_modules_dashdash__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</pre><h1><a class="anchor" id="autotoc_md8290"></a>
Usage</h1>
...
</pre><h1><a class="anchor" id="autotoc_md8293"></a>
Bash completion</h1>
...
<li><code>helpWrap</code> (Boolean). Optional, default true. Set this to <code>false</code> to have that option's <code>help</code> <em>not</em> be text wrapped in <code>&lt;parser&gt;.<a class="el" href="no-config-found_8txt.html#aacb454271389f84eeb44bc8f0111570a">help()</a></code> output.</li>
