...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c___users__joseph_workspace__state_bills__box_site_frontend_node_modules_to-regex__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md21742"></a>
Usage</h1>
...
<div class="line">//=&gt; /^(?:(?:(?!(?:(?:foo)|(?:bar))).)*)$/</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md21743"></a>
Options</h1>
...
<div class="line">console.log(toRegex(&#39;foo&#39;, {negate: true}));</div>
<div class="line">//=&gt; /^(?:(?:(?!^(?:foo)$).)*)$/</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md21746"></a>
options.nocase</h2>
<p><b>Type</b>: <code>Boolean</code></p>
<p><b>Default</b>: <code>undefined</code></p>
...
<h2><a class="anchor" id="autotoc_md21747"></a>
options.flags</h2>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md21750"></a>
About</h1>
<p>&lt;details&gt;</p>
