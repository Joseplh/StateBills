...
<title>BoxSite: node-fetch</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c___users__joseph_workspace__state_bills__box_site_frontend_node_modules_node-fetch__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md15194"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md15195"></a>
Common Usage</h1>
...
<h3><a class="anchor" id="autotoc_md15196"></a>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15197"></a>
JSON</h3>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15198"></a>
Simple Post</h3>
...
<div class="line">    .then(json =&gt; console.log(json));</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15199"></a>
Post with JSON</h3>
...
<div class="line">    .then(res =&gt; res.json())</div>
<div class="line">    .then(json =&gt; console.log(json));</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15200"></a>
...
<div class="line">    .then(res =&gt; res.json())</div>
<div class="line">    .then(json =&gt; console.log(json));</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15201"></a>
...
<div class="line">    });</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md15205"></a>
Buffer</h3>
...
<div class="line">}</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md15214"></a>
Default Headers</h4>
...
<h4><a class="anchor" id="autotoc_md15215"></a>
Custom Agent</h4>
...
<h2><a class="anchor" id="autotoc_md15216"></a>
Class: Request</h2>
...
<h3><a class="anchor" id="autotoc_md15226"></a>
body.bodyUsed</h3>
<p><small>*(spec-compliant)*</small></p>
<ul>
...
body.arrayBuffer()</h3>
<h3><a class="anchor" id="autotoc_md15228"></a>
body.blob()</h3>
<h3><a class="anchor" id="autotoc_md15229"></a>
body.json()</h3>
<h3><a class="anchor" id="autotoc_md15230"></a>
body.text()</h3>
<p><small>*(spec-compliant)*</small></p>
<ul>
...
<h2><a class="anchor" id="autotoc_md15234"></a>
Class: AbortError</h2>
<p><small>*(node-fetch extension)*</small></p>
