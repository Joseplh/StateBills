...
<title>BoxSite: compression</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c___users__joseph_workspace__state_bills__box_site_frontend_node_modules_compression__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md6790"></a>
...
<h4><a class="anchor" id="autotoc_md6792"></a>
chunkSize</h4>
...
<h4><a class="anchor" id="autotoc_md6793"></a>
filter</h4>
...
<h4><a class="anchor" id="autotoc_md6794"></a>
level</h4>
...
<h4><a class="anchor" id="autotoc_md6795"></a>
memLevel</h4>
...
<p>See <a href="http://nodejs.org/api/zlib.html#zlib_memory_usage_tuning">Node.js documentation</a> regarding the usage.</p>
<h4><a class="anchor" id="autotoc_md6796"></a>
strategy</h4>
...
<p><b>Note</b> in the list above, <code>zlib</code> is from &lsquo;zlib = require('zlib&rsquo;)`.</p>
<h4><a class="anchor" id="autotoc_md6797"></a>
threshold</h4>
...
<h4><a class="anchor" id="autotoc_md6798"></a>
windowBits</h4>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md6800"></a>
res.flush</h2>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md6803"></a>
...
<div class="line">  })</div>
<div class="line">})</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md6804"></a>
License</h1>
<p>[MIT](LICENSE) </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
